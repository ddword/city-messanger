...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'add.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/add.html'`` the file from the app1 package is loaded,
    by loading ``'app2/add.html'`` the file from the second.
    """
